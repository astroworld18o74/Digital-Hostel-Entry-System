...
<%String n=session.getAttribute("n").toString(); %>
	...
	<div class="container">
		...
		<form name="frm7" method="post" action="securitytable.jsp" onsubmit="return b()">
		...
		<br/>
			...
			<h5><select name="field"><option value="admin">Admin</option><option value="security">Security</option></select></h5>
			<br/><br/>
