...
<div><h3 class="b"  class=" w3-center" style="padding:90px 8px">Student Entry Record</h3></div>
<h2 align="center"><i><b>
...
<a href="logout.jsp">LOGOUT>></a></b></i></h2><br/>
   ...
   Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","root");
    ...
    <tr><td>Roll No.</td><td>Name</td><td>Room No.</td><td>Phone No.</td><td>Place</td><td>Date</td><td>Time Out</td><td>Time In</td><td>Student_id</td></tr>
    <%
    while(rs.next()){
